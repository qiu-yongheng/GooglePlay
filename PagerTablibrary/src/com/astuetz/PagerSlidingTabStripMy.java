...
public class PagerSlidingTabStripMy extends HorizontalScrollView {
	/**-------------add begin--------------**/
	//默认值
	...
	public PagerSlidingTabStripMy(Context context) {
		this(context, null);
	}

	public PagerSlidingTabStripMy(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public PagerSlidingTabStripMy(Context context, AttributeSet attrs, int defStyle) {
		...
		/**-----------add begin-----------**/
		tabTextSize = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsTabTextSize, textSize);
		tabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsTabTextColor, textColor);
...
//
//		int triangleWidth = indicatorHeight;
